            ...
            <div className="w-full max-w-md">
                ...
                <div className="bg-white/60 backdrop-blur-2xl border border-white/50 shadow-2xl rounded-3xl p-8 md:p-10">
                    <div className="text-center mb-8">
                        ...
                        <p className="text-gray-500 text-sm mt-2">Sign in to access your workspace</p>
                    </div>
                ...
                <p className="text-center text-gray-500 text-sm mt-8">
                    Don't have an account? <Link href="/register" className="text-gray-900 font-medium hover:underline">Create Account</Link>
                </p>
            </div>
        </div>
    )
